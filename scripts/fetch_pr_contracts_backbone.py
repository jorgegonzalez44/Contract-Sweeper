"""Fetch PR contracts master from USAspending."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Fetch PR contracts master from USAspending")
    ...
    result = fetcher.fetch_contracts(args.fiscal_years)
